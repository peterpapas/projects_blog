      ...
      <section class="error">
        ...
        <div class="error__content">
          <div class="error__message message">
            <h1 class="message__title">4🙃4</h1>
            <p class="message__text">Oops! We can't find the page you're looking for. It might have been moved to a new
              galaxy. Let's teleport you back to our Home Page.</p>
          </div>
          <div class="error__nav e-nav">
            <router-link to="/" target="_blank" class="button-82-pushable">
...
.light {
  width: 200px;
  height: 0px;
  border-bottom: 200vh solid rgba(44, 255, 255, 0.24);
  /* Use viewport height for the light */
  ...
  top: 270px;
  /* Adjust this if needed to position the top of the light */
  z-index: 1;
...
.button-82-pushable {
  display: inline-block;
  /* Allows it to be used with router-link */
  position: relative;
  background: transparent;
  padding: 0;
  cursor: pointer;
